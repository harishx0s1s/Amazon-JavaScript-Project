...
describe('Test suite: product',()=>{
  ...
  it('gets the exact price with strings',()=>{
    expect(product.getPrice()).toEqual('$10.90')
  });

  it('does not display any extra html',()=>{
...
describe('Test Suite: Clothing',()=>{
  ...
  it('test the product is correct',()=>{
...
describe('Test suite: Appliance',()=>{
  ...
  it('display warrenty  and instruction info',()=>{
    expect(appliance.extraInfoHTML()).toContain('Instructions')
    expect(appliance.extraInfoHTML()).toContain('Warrenty')
  })
})